...
{
    public static class IsMobileExtension
    {
        public static bool IsMobile()
        {
            ...
            if (!string.IsNullOrEmpty(device_info)) // mobil ise sayfaya görüntülenir
                return true;
            else
                return false;
    ...
    public class BaseController : Controller
    {
        ...
        public bool isMobileBrowser(out string device)
        {
            device = "web";
        ...
        //private BircamDBEntities db = new BircamDBEntities();
        ...
        //    var member = new MemberRepo().GetByFilter(q => q.UserID == userID);

        //    if (member != null)
        //    {
        //        retval = member.FullName;
        //    }
