...
function NeroCtrl($scope, $http, $window, $filter, DTOptionsBuilder, DTColumnBuilder) {
                ...
                if ($scope.FormModel.ID == null) {
                   ...
                   // table.rows.add($scope.FormModel).draw();
                    table.rows.add([{
                        ...
                        "RankNumber": $scope.FormModel.RankNumber,
                        "IsActive": $scope.FormModel.IsActive
                    }]).draw();
        ...
        $http({
            ...
            .then(function (response) {
                ...
                $window.setTimeout(function () {
                    ...
                    $scope.FormModel = response.data.CariVade;
    ...
    $scope['Listele'] = function (start, end) {
        ...
        $scope.dtColumns = [
            ...
            DTColumnBuilder.newColumn("Name", "Ad"),
