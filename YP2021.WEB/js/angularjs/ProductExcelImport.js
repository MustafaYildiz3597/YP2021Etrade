...
function NeroCtrl($scope, $http, $timeout, $window, $filter) {
    ...
    $scope.Upload = function () {
        ...
        $scope.FormModel.ENABLED = null;
        $scope.FormModel.NAME = null;
        $scope.FormModel.NAME_EN = null;
        $scope.FormModel.NAME_DE = null;
        $scope.FormModel.NAME_FR = null;
        $scope.FormModel.EDITOR_TABLE = null;
        $scope.FormModel.EDITOR_TABLE_EN = null;
        $scope.FormModel.EDITOR_TABLE_GR = null;
        $scope.FormModel.EDITOR_TABLE_FR = null;
    ...
    $scope.StartTransferFromExcel = function () {
        ...
        angular.forEach($scope.excelRows, function (row) {
            dt.ExcelRows.push({
                ...
                "ENABLED": row[$scope.FormModel.ENABLED],
                "NAME": row[$scope.FormModel.NAME],
                "NAME_EN": row[$scope.FormModel.NAME_EN],
                "NAME_DE": row[$scope.FormModel.NAME_DE],
                "NAME_FR": row[$scope.FormModel.NAME_FR],
                "EDITOR_TABLE": row[$scope.FormModel.EDITOR_TABLE],
                "EDITOR_TABLE_EN": row[$scope.FormModel.EDITOR_TABLE_EN],
                "EDITOR_TABLE_GR": row[$scope.FormModel.EDITOR_TABLE_GR],
                "EDITOR_TABLE_FR": row[$scope.FormModel.EDITOR_TABLE_FR]
            });
        });
    ...
    $scope.UploadSelectedRows = function (isValid) {
        ...
        $http({
            url: "/api/Product/ImportExcelUploadData/"
            , method: "POST"
            , params: {}
