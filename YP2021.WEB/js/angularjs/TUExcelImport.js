var app = angular.module('NeroApp', ['ngSanitize', 'scrollable-table', 'angular.filter', 'ngFileUpload', 'ui.select']);
...
function NeroCtrl($scope, $http, $timeout, $window, $filter) {
    ...
    $scope.Upload = function () {
        ...
        $scope.FormModel.CURRENCY = null;
        $scope.FormModel.XPSNO = null;
        $scope.FormModel.OEM = null;
        ...
        $window.setTimeout(function () {
            ...
            angular.forEach($scope.excelRows, function (row) {
                dt.ExcelRows.push({
                    ...
                    "NAME": row[$scope.FormModel.NAME],
                    "NAME_EN": row[$scope.FormModel.NAME_EN],
                    "NAME_DE": row[$scope.FormModel.NAME_DE],
                    "PRICE": row[$scope.FormModel.PRICE],
                    "CURRENCY": row[$scope.FormModel.CURRENCY],
                    "XPSNO": row[$scope.FormModel.XPSNO],
                    "OEM": row[$scope.FormModel.OEM]
                });
            });
    ...
    $scope.ShowImportPopup = function () {
    ...
    $scope.UploadSelectedRows = function (isValid) {
        ...
        var jsondata = {
            ...
            "MusteriID": $scope.UploadExcelFormModel.selectedTedarikci.ID
        };
        ...
        $http({
            url: "/api/TProducts/ImportExcelUploadData/"
            , method: "POST"
            , params: {}
            ...
            $window.setTimeout(function () {
                ...
                $scope.AddedCount = response.data.AddedCount;
                $scope.UpdatedCount = response.data.UpdatedCount;
                $scope.UnProccessedCount = response.data.UnProccessedCount;
    ...
    $scope.FillAllCmbs = function () {
        ...
        $http({
            url: "/api/TProducts/ExcelImportFillAllCmb/"
            , method: "POST"
            , params: {}
            , contentType: "application/json"
            , data: {}
            ...
            .then(function (response) {
                //$scope.Oemsupliers = data.Oemsupliers;
                //$scope.Musteriler = data.Musteriler;
