					...
					<header class="page-header">
						...
						<div class="right-wrapper text-right">
							<ol class="breadcrumbs">
								...
								<li><span>Bordro Gönderim Ekranı</span></li>
							</ol>
							...
							<div class="col-lg-3">
								...
								<section class="card">
									...
									<div class="card-body">
										<div class="form-group row">
											<div class="col-sm-12">
												<input type="text" name="kepadresi" placeholder="KEP Adresi" class="form-control">
											</div>
										</div>
										<div class="form-group row">
											<div class="col-sm-10">
										...
										<div class="form-group row">
											<div class="col-sm-12">
												<input type="text" name="yetkilikodu" placeholder="Yetkili Kodu" class="form-control">
											</div>
										</div>
									</div>
								</section>
								<section class="card">
									...
									<div class="card-body">
										<div class="form-group row">
											<div class="col-sm-12">
												<input type="text" name="cc" placeholder="CC" class="form-control">
											</div>
										</div>
										<div class="form-group row">
											<div class="col-sm-12">
												<input type="password" name="konu" placeholder="Konu" class="form-control">
											</div>
										</div>
										<div class="form-group row">
											<div class="col-sm-12">
												<textarea class="form-control" rows="5" placeholder="İçerik"></textarea>
											</div>
										</div>
									</div>
									<footer class="card-footer text-right">
										<center><button class="btn btn-light" style="width:100%; color:#0088cc;">Gönder</button></center>
										<br>
										<center><a href="#" class="btn btn-light" style="width:100%;color:#0088cc;">Seçilenleri İmzaya Geri Gönder</a></center>
										<br>
										<center><a href="#" class="btn btn-light" style="width:100%;color:#0088cc;">Seçilenleri Sil</a></center>
										<hr>
										<center>Çalışan Sayısı / PDF Sayısı: <b>4/4</b></center>
									</footer>
							...
							<div class="col-lg-9">
								<section class="card">
									<header class="card-header">
										...
										<h2 class="card-title">Bordro Gönderim Ekranı</h2>
									</header>
									<div class="card-body">
										<table class="table table-bordered table-striped mb-0" id="datatable-default">
											...
											<tbody>
												<tr>
													...
													<td>kepadresi</td>
													<td>PDFERR</td>
													<td>Gönderim Bekliyor</td>
													<td>İmzalandı</td>
													<td>C:\Users\PC\AppData\Local\Apps\...</td>
												</tr>
												<tr>
													<td></td>
													<td>Ayşe</td>
