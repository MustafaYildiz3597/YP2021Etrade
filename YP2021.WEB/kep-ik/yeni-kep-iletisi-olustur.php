			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					<header class="page-header">
						<h2>Yeni KEP İletisi Oluştur</h2>
						...
						<div class="right-wrapper text-right">
							<ol class="breadcrumbs">
								...
								<li><span>Yeni KEP İletisi Oluştur</span></li>
							</ol>
					...
					<?php include('kep-ik-topmenu.php'); ?>
							...
							<div class="col">
								<section class="card">
									<header class="card-header" style="border-bottom:0px!important; margin-bottom:15px;">
										...
										<h2 class="card-title">Yeni KEP İletisi Oluştur</h2>
									</header>
										<div class="row">
						<div class="col-lg-6">
							<form id="form1" class="form-horizontal">
								<section class="card">
									<header class="card-header">
										...
										<h2 class="card-title">e-İmza Bilgileri</h2>
									</header>
									<div class="card-body">
										<div class="form-group row">
											<label class="col-sm-2 control-label text-sm-right pt-2">e-İmza: </label>
											<div class="col-sm-10">
										...
										<div class="form-group row">
											<label class="col-sm-2 control-label text-sm-right pt-2">Pin: </label>
											<div class="col-sm-8">
						...
						<div class="col-lg-6">
								<section class="card">
									<header class="card-header">
										<h2 class="card-title">Gönderen KEP Bilgileri</h2>
									</header>
									<div class="card-body">
										<div class="form-group row">
											<label class="col-sm-4 control-label text-sm-right pt-2">KEP Adresi:</label>
											<div class="col-sm-8">
												<input type="text" name="kepadresi" class="form-control">
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-4 control-label text-sm-right pt-2">Şifre:</label>
											<div class="col-sm-8">
												<input type="password" name="sifre" class="form-control">
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-4 control-label text-sm-right pt-2">Yetkili Kodu:</label>
											<div class="col-sm-8">
												<input type="text" name="yetkilikodu" class="form-control">
											</div>
										</div>
									</div>
								</section>
						...
						<div class="col-lg-12" style="margin-top:15px;">
								<section class="card">
									<header class="card-header">
										<h2 class="card-title">KEP İçeriği</h2>
									</header>
									<div class="card-body">
										<div class="form-group row">
											<label class="col-sm-2 control-label text-sm-right pt-2">Kime:</label>
											<div class="col-sm-10">
												<input type="text" name="kime" class="form-control">
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-2 control-label text-sm-right pt-2">CC:</label>
											<div class="col-sm-10">
												<input type="text" name="cc" class="form-control">
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-2 control-label text-sm-right pt-2">Konu:</label>
											<div class="col-sm-10">
												<input type="text" name="konu" class="form-control">
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-2 control-label text-sm-right pt-2">İçerik:</label>
											<div class="col-sm-10">
												<textarea class="form-control" name="icerik" rows="5"></textarea>
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-2 control-label text-sm-right pt-2">Ekler:</label>
											<div class="col-sm-10">
												<select class="form-control mb-3" required="">
													<option value="">Ek Seçiniz</option>
												</select>
											</div>
										</div>
										<footer class="card-footer text-right">
										<center><button class="btn btn-light" style="color:#0088cc;"><i class="fa fa-share"></i>&nbsp;Gönder</button>
										<a href="#" class="btn btn-light" style="color:#0088cc;"><i class="fa fa-folder"></i>&nbsp;Ek</a>
										<a href="#" class="btn btn-light" style="color:#0088cc;"><i class="fa fa-undo"></i>&nbsp;Sıfırla</a></center>
									</footer>
									</div>
								</section>
							</form>
