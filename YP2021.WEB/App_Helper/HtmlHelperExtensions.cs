    ...
    public static class HtmlHelperExtensions
    {
        ...
        public static IHtmlString RouteIf(this HtmlHelper helper, string value, string attribute)
        {
            ...
            var currentController =
                (helper.ViewContext.RequestContext.RouteData.Values["controller"] ?? string.Empty).ToString().ToLower().UnDash();
            var currentAction =
                (helper.ViewContext.RequestContext.RouteData.Values["action"] ?? string.Empty).ToString().ToLower().UnDash();
        ...
        public static IHtmlString RouteIfTree(this HtmlHelper helper, string value, string attribute)
        {
            var currentController =
            ...
            // var hasController = value.Equals(currentController, StringComparison.InvariantCultureIgnoreCase);
            var hasController = currentController.Contains(value);
            var hasAction = value.Equals(currentAction, StringComparison.InvariantCultureIgnoreCase);

            return hasAction || hasController ? new HtmlString(attribute) : new HtmlString(string.Empty);
        }

        public static IHtmlString RouteIfMultiple(this HtmlHelper helper, string[] values, string attribute)
        {
            var currentController =
                (helper.ViewContext.RequestContext.RouteData.Values["controller"] ?? string.Empty).ToString().UnDash();
            var currentAction =
            ...
            {
                hasController = item.Equals(currentController, StringComparison.InvariantCultureIgnoreCase);
                hasAction = item.Equals(currentAction, StringComparison.InvariantCultureIgnoreCase);
        ...
        public static IHtmlString RouteIf(this HtmlHelper helper, string _controller, string _action, string attribute)
        {
            ...
            var hasController = _controller.Equals(currentController, StringComparison.InvariantCultureIgnoreCase);
            var hasAction = _action.Equals(currentAction, StringComparison.InvariantCultureIgnoreCase);
